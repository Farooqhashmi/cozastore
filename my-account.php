...
<section class="bg0 p-t-104 p-b-116">
    <div class="container center-container">
        <div class="size-160 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
            ...
            <form action="update-profile.php" method="post">
                <div class="bor8 m-b-20 how-pos4-parent">
                    ...
                    <img class="how-pos4 pointer-none" src="images/icons/user.png" alt="ICON" width="23">
                </div>
                <div class="bor8 m-b-20 how-pos4-parent">    
                    ...
                    <img class="how-pos4 pointer-none" src="images/icons/email.png" alt="ICON" width="23">
                </div>
                <div class="bor8 m-b-20 how-pos4-parent">
                    ...
                    <img class="how-pos4 pointer-none" src="images/icons/phone.png" alt="ICON" width="23">
                </div>
                <div class="bor8 m-b-20 how-pos4-parent">
                    ...
                    <img class="how-pos4 pointer-none" src="images/icons/address.png" alt="ICON" width="23">
                </div>
                <div class="bor8 m-b-20 how-pos4-parent">
                    ...
                    <img class="how-pos4 pointer-none" src="images/icons/dob.png" alt="ICON" width="23">
                </div>
                <div class="bor8 m-b-20 how-pos4-parent">
                    <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" name="newpassword" placeholder="New Password">
                    <img class="how-pos4 pointer-none" src="images/icons/password.png" alt="ICON" width="23">
                </div>
                <div class="bor8 m-b-20 how-pos4-parent">
                    <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" name="confirmpassword" placeholder="Confirm Password">
                    <img class="how-pos4 pointer-none" src="images/icons/enter.png" alt="ICON" width="23">
                </div>
