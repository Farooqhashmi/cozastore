			...
			?>
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="<?php echo $proImgRef . $provalues['productImage'] ?>" alt="IMG-PRODUCT">
							</div>
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="product-detail.php?pid=<?php echo $provalues['productId'] ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										<?php echo $provalues['productName'] ?>
									</a>
									<span class="stext-105 cl3">
										$<?php echo $provalues['productPrice'] ?>
									</span>
								</div>
				...
				?>
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="<?php echo $proImgRef . $proVal['productImage'] ?>" alt="IMG-PRODUCT">
							</div>
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
